 ...
 * Mateusz Mroczka <mm439938@students.mimuw.edu.pl>
 ...
 * Usuwa strukturę wskazywaną przez @p pf. Nic nie robi,
 * jeśli wskaźnik ten ma
 * wartość NULL.
 ...
 * Dodaje przekierowanie wszystkich numerów mających prefiks
 * @p num1, na numery,
 * w których ten prefiks zamieniono odpowiednio na prefiks @p num2. 
 * Każdy numer jest swoim własnym prefiksem. 
 * Jeśli wcześniej zostało dodane przekierowanie
 ...
 *         reprezentuje numeru, oba podane numery są identyczne
 ...
 * parametru @p num1 użytego przy dodawaniu.
 * Jeśli nie ma takich przekierowań
 ...
 * prefiksu. Wynikiem jest ciąg zawierający co najwyżej jeden numer. 
 * Jeśli dany numer nie został przekierowany, 
 * to wynikiem jest ciąg zawierający ten numer.
 ...
 * przechowującą przekierowania numerów;
 * @param[in] num – wskaźnik na napis reprezentujący numer.
 * @return Wskaźnik na strukturę przechowującą ciąg numerów lub NULL,
 *         gdy nie udało się alokować pamięci.
 */
PhoneNumbers * phfwdGet(PhoneForward const *pf, char const *num);

/** @brief Wyznacza przekierowania na dany numer.
 * Wyznacza wszystkie numery w @p pf, dla których prefiksu 
 * istnieje takie przekierowanie, że numer ten po przekierowaniu prefiksu
 * byłby równy z numerem @p num.
 * Dodatkowo ciąg wynikowy zawsze zawiera też numer @p num. 
 * Wynikowe numery są posortowane leksykograficznie
 * i nie mogą się powtarzać. Jeśli podany napis nie
 * reprezentuje numeru, wynikiem jest pusty ciąg. Alokuje strukturę
 * @p PhoneNumbers, która musi być zwolniona za pomocą funkcji
 * @ref phnumDelete.
 * @param[in] pf  – wskaźnik na strukturę
 * przechowującą przekierowania numerów;
 * @param[in] num – wskaźnik na napis reprezentujący numer.
...
/** @brief Funkcja odwrotna do funkcji @ref phfwdGet.
 * Wyznacza wszystkie numery, które są przekierowane na podany napis.
 * Wynikowe numery są uporządkowanie leksykograficznie
 * i nie powtarzają się.
 * Jeśli podany napis nie reprezentuje numeru, wynikiem jest pusty ciąg.
 * Alokuje struktórę @p PhoneNumbers, która musi być zwolniona za pomocą 
 * funkcji @ref phnumDelete.
 * @param[in] pf – wskaźnik na strukturę przechowującą
 * przekierowania numerów.
 * @param[in] num – wskaźnik na napis przechowujący numer.
...
/** @brief Usuwa strukturę.
 * Usuwa strukturę wskazywaną przez @p pnum. Nic nie robi,
 ...
 * ciąg numerów telefonów;
 * @param[in] idx  – indeks numeru telefonu.
 * @return Wskaźnik na napis reprezentujący numer telefonu.
 *         Wartość NULL, jeśli wskaźnik @p pnum ma wartość NULL
 *         lub indeks ma za dużą wartość.
 */
